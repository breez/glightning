  ...
  "peers": [                                                                                                                                              
    {
	  ...
	  "their_reserve_msat": 167773000,
          "our_channel_reserve_satoshis": 167773,
	  "our_reserve_msat": 167773000,
          "spendable_msatoshi": 16609442000,
	  "spendable_msat": 16609442000,
          "htlc_minimum_msat": 10,
          "minimum_htlc_in_msat": 10,
			...
			Channels: []*glightning.PeerChannel{
				{
					...
					TheirReserveMsat:                 167773000,
					OurChannelReserveSatoshi:         167773,
					OurReserveMsat:                   167773000,
					SpendableMilliSatoshi:            16609442000,
					SpendableMsat:                    16609442000,
					HtlcMinMilliSatoshi:              10,
					MinimumHtlcInMsat:                10,
					TheirToSelfDelay:                 6,
					OurToSelfDelay:                   6,
...
`)
	...
	lightning, requestQ, replyQ := startupServer(t)
	go runServerSide(t, req, resp, replyQ, requestQ)
	result, err := lightning.FundChannelExt(id, sats, feeRate, false, nil, nil, nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
`)
	...
	go runServerSide(t, req, resp, replyQ, requestQ)
	_, err = lightning.FundChannelExt(id, sats, feeRate, false, nil, nil, nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
`)
	...
	go runServerSide(t, req, resp, replyQ, requestQ)
	_, err = lightning.FundChannelExt(id, sats, feeRate, false, nil, msat, nil, nil)
	if err != nil {
		t.Fatal(err)
	}
